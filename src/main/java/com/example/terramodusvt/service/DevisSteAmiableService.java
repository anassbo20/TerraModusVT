package com.example.terramodusvt.service;
...
import com.example.terramodusvt.repositories.DemandeurSteRepository;
import com.example.terramodusvt.repositories.ImmobRepository;
import com.example.terramodusvt.repositories.TypeDevisRepository;
import com.example.terramodusvt.repositories.devisSte.DevisSteAmiableRepository;
...
public class DevisSteAmiableService {
    ...
    public DevisSteAmiable saveDevise(DevisSteAmiable devise) throws MessagingException, jakarta.mail.MessagingException, JRException, IOException, ParseException, XmlException {
            ...
            FileInputStream inputStream = new FileInputStream("src/main/resources/Amiable.docx");
